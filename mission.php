...
<li>Fostering Knowledge Creation</li>
<li>Upholding Human Values</li>
<li>Promoting Sustainable Development </li>
<img src="upload/mission.jpg">

<p></p>

<div class="widget-title">	
<h4>VISION BracU 2.0</h4>
	<hr>
	</div>

	<li>Proud, global institution from Bangladesh</li>
	<li>Bangladesh's flagship university</li>
	<img src="upload/vission.jpg">
