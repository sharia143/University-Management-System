...
<div class="widget-title">
<h4>BRAC Business School</h4>
	<hr>
	</div>
BRAC Business School
<li>Asian Institute of Management, Manila</li>
<li>Asian Institute of Technology, Bangkok</li>
<li>Bloomsburg University of Pennsylvania, USA</li>
<li>University of South Australia</li>
<p></p>

<div class="widget-title">
<h4>James P Grant School of Public Health</h4>
	<hr>
	</div>
	<li>James P Grant School of Public Health</li>
	<li>Beijing National and Guangxi Provincial</li>
	<li>Centres for Diseases Control, China</li>
	...
	<li>George Washington University, USA</li>
	<li>Harvard School of Public Health, Harvard University, USA</li>
	<li>Institute of Development Studies</li>
	<li>University of Sussex, UK</li>
	<li>Karolinska Institutet, Sweden</li>
	<li>London School of Hygiene and Tropical Medicine, UK</li>
	<li>Mailman School of Public Health, Columbia University, USA</li>
	<li>National Institute of Preventive and Social Medicine (NIPSOM), Bangladesh</li>
	<li>School of Medical Sciences, Kwame Nkrumah University of Science and Technology (KNUST), Ghana</li>
	<li>Sree Chitra Tirunal Institute for Medical Sciences and Technology, Trivandrum, Kerala, India</li>
	<li>University of Amsterdam, The Netherlands</li>
	<li>University of Heidelberg, Germany</li>
	<li>University of Illinois at Springfield, USA</li>
	<li>University of Nagasaki, Japan</li>

	<div class="widget-title">
<h4>Department of Architecture</h4>
	<hr>
	</div>
	<li>University of Illinois, Chicago, USA</li>
	<li>Universite de Nice Sophia Antipolis, France</li>
	<li>Lancaster University, UK</li>
	<li>Loughborough University of New Ashby Road, Leicestershire, UK</li>
	<li>British Council</li>

<p></p>
<div class="widget-title">
<h4>Postgraduate Programs in Disaster Management</h4>
	<hr>
	</div>
	<li>Asian Disaster Preparedness Center, Thailand</li>
	<li>Asian University Network of Environment and Disaster Management (AUEDM)</li>
	<li>Katmandu University, Nepal</li>
	<li>Kyoto University, Japan</li>
	<li>Northumbria University, UK</li>

<p></p>
<div class="widget-title">
<h4>Department of Mathematics and Natural Sciences</h4>
	<hr>
	</div>
	<li>Bangladesh Atomic Energy Commission (BAEC)</li>
	<li>BIRDEM, Dhaka, Bangladesh</li>
	<li>BRACARDC, Gazipur, Bangladesh</li>
	<li>CNRS, CEA, Grenoble, France</li>
	<li>ICDDR,B, Dhaka, Bangladesh</li>
	<li>University of Dhaka, Dhaka, Bangladesh</li>
	<li>BCSIR, Dhaka Bangladesh</li>
...
<h4>School of Humanities and Social Sciences</h4>
	<hr>
       ...
       1. Bifrost Bridges global coalition on sustainability: https://bifrostonline.org/about/<br>
       2. Club of Rome: https://clubofrome.org/<br>
       3. Swiss Academic Society for Environmental Research and Ecology: https://naturalsciences.ch/organisations/saguf<br>
       4. UNESCO Management of Social Transformations program: https://en.unesco.org/themes/social-transformations/most<br>
       5. World Academy of Art and Science: http://www.worldacademy.org/<br>
