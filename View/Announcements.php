...
<p></p>
  ...
  <div class="pad-bottom-small">
        <p></p><p>Since its inception in 2001, Brac University has become one of the most reputed educational institution in Bangladesh. We have focused on generating new knowledge and promoting critical thinking amongst our students, graduating more than 7,000 young men and women during this time.</p><p></p>
  </div>
      <a href="http://www.bracu.ac.bd/message-founder-and-chairperson" class="button arrow-right">View More</a>
  </div>

<div class="columns small-12 medium-6">

                    <div class="img-content has-title">
          <img src="https://www.bracu.ac.bd/sites/default/files/styles/16_9_medium_530x298/public/widget_images/static_content/Sir%20FH%20Abed.jpg?itok=mhUJC7oW" alt="">
          <div class="img-title">Sir Fazle Hasan Abed, KCMG</div>
        </div>
...
<div class="strip-bg-white">
  <div class="row pad-tb-large">
    <div class="columns small-12">
        ...
        <div class="columns small-12 medium-6">
  <div class="pad-bottom-small">
        <p></p><p>Brac University is ranked highly in this country. This is a great achievement. However, in the global landscape of higher education, we are still off the radar. We are behind the world's best in our practices and standards. But we do not intend to stay that way. We choose to aim ambitiously high. We shall continuously improve this University. We shall benchmark ourselves against the best and eventually become one of them. Achieving such a goal demands a long vision, a brave heart and an unwavering commitment. And it is an undertaking that requires the dedication of the entire community of stakeholders. This is surely not an easy journey, nor is it quick. We may not be able to get there during my tenure as Vice Chancellor, but I am sure we will get there. And we shall now take the first step.</p><p></p>
  </div>
      <a href="https://www.bracu.ac.bd/about/people/professor-vincent-chang-phd" class="button arrow-right">View More</a>
  </div>

<div class="columns small-12 medium-6">

                    <div class="img-content has-title">
          <img src="https://www.bracu.ac.bd/sites/default/files/styles/16_9_medium_530x298/public/widget_images/static_content/Vincent%20Chang%20Edited.JPG?itok=FHxY7Sys" alt="">
          <div class="img-title">Professor Vincent Chang, PhD</div>
        </div>
