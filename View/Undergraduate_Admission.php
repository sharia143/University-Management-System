...
<li class="dropdown ttmenu-half"><a class="active" href="#" data-toggle="dropdown" class="dropdown-toggle">International Applicants<b class="fa fa-angle-down"></b></a>
	<ul class="dropdown-menu">
	<li>
	<div class="ttmenu-content">
	<div class="row">
...
<p></p>
	...
	<div class="field-item even">
          <p>BracU offers excellent facilities to International students for studying in Bangladesh in various programs at the undergraduate level. Visit the link for detailed admissions programs: <a href="//www.bracu.ac.bd/academics/programs/undergraduate">https://www.bracu.ac.bd/academics/programs/undergraduate</a></p>
<p><strong>Application deadlines:</strong></p>
<p>BracU offers three semesters in each academic year - Spring, Summer and Fall. International students can apply any time during the year. There is no application deadline for International Applicant.</p>
<p><strong>Application for admission</strong></p>
<p>A member of BracU International Student Recruitment Team will assist you to complete your admission application. We aim to make your admissions process as simple and easy as possible.</p>
<p><strong>Minimum qualifications for applying</strong></p>
<p>Students have to submit all necessary academic documents to the International Office or may email scanned copies of these to <a href="mailto:international-office@bracu.ac.bd" processed="processed">info.international-office@bracu.ac.bd</a>. Students will be informed about their eligibility for being admitted once these documents have been scrutinized and evaluated.</p>
<p><strong>Documents Required </strong></p>
<p>The academic and other related documents required for admission to BracU are as follows:</p>
<ul><li>Completed admission application form</li>
<li>Original Copy of academic transcripts/certificates</li>
<li>Statement from your home institute which confirms medium of instruction is English</li>
<li>Police Clearance Certificate from your country of origin/No Objection Letter (NOC) from your home institute</li>
<li>Valid passport and Student visa</li>
<li>Health checkup/medical certificates</li>
</ul><p><strong>Academic Qualifications for Undergraduate Admission</strong></p>
<ul><li><strong>Academic qualifications (for all Undergraduate Programs Except Pharmacy)</strong></li>
</ul><p>Minimum GPA of 3.5 in O-Levels in five subjects and A-Levels in two subjects according to the Brac University scale (A=5, B=4, C=3 &amp; D=2).&nbsp;Subjects with E grade will not be considered.</p>
<p>Candidates who have completed higher secondary education (12 years of schooling) under a system different from 0/A Level or equivalent will be considered.</p>
<p>Candidates with a break of study of not more than three years may apply for admission.</p>
<ul><li><strong>Academic qualifications (for Pharmacy only)</strong></li>
</ul><p>Candidates must have a minimum aggregate GPA 7.00 in “O” level/equivalents and “A” level/equivalents examinations (on a total scale of 10).</p>
<p>Candidates must pass “O” level/recognized equivalents and “A” level/recognized equivalents in the Science Group and obtain a minimum GPA 3.5 (on a scale of 5) without any additional subject.</p>
<p>Candidates must pass “A” level/recognized equivalent examination with a minimum GPA 3.0 in Chemistry and Biology separately and a minimum GPA 2.0 in Mathematics (on a scale of 5).</p>
<p>Candidates must pass “A” level/equivalents with the following science subjects: Physics, Chemistry, Biology and Mathematics.</p>
<p>Candidates must pass “A” level/recognized equivalent examination in the current year or previous year.</p>
<p>Foreign students must pass 12 years of education, with similar grades in equivalent examinations recognized from foreign institutions.</p>
<ul><li><strong>Subject Requirements for particular programs at undergraduate level</strong></li>
</ul><p>Please visit the link for details: <a href="//www.bracu.ac.bd/admissions/undergraduate">https://www.bracu.ac.bd/admissions/undergraduate</a></p>
<p><strong>Admission Test:</strong></p>
<p>All eligible candidates will have to sit for a written admission test and an interview. Those who qualify in the written test will be called for interview for final selection.</p>
<p>Written Admission test for the international students will be taken according to current practice, which is administered by Brac International Offices. Where there is no Brac office, partnership with local academic institutions will be made for administering the admission test.</p>
<p><em>Applicants of EMBA are not required to give written test but must pass a viva for admission.</em></p>
<p><strong>Interview</strong></p>
<p>All qualified applicants of written admission test will have to give their viva on line on a specified date and time.</p>
<p><br><strong>Admission test exemption</strong></p>
<p>Applicants will get written admission test exemption if they have a minimum SAT score of 1550 (Old)/SAT score 1050 (New) for ANT, ENG, LLB, BBA, ECO, BIO, MIC, CS, CSE, ECE, EEE, MAT, APE, PHY and TOEFL paper based score of 550/ TOEFL IBT score of 79 for ANT, ENG, LLB or IELTS score of 6.5 for ANT, ENG, LLB. They must provide proper evidence to get written test exemption through email minimum 15 days before the admission test.</p>
<p><strong>Provisional admission</strong></p>
<p>Some students wishing to join the University may not have the required standard of proficiency in English language. If students fail to attain the minimum standard of English proficiency required by the University, they may be asked to attend remedial English courses before admission. At the end of this course they will have to take an English proficiency test and if successful will be admitted to BracU<strong>.</strong></p>
<p><strong>Credit Transfer&nbsp;</strong></p>
<p>Credit transfer from an educational institution with a system similar to Brac University may be considered after admission. Such candidates will have to apply with the required documents and are subject to the credit transfer rules of BRAC University.</p>
<p>The total credits transferred by a student from other universities should not exceed 50 (or 65 credits for students of Architecture Department). The student must meet the residency requirement of at least two years at Brac University.</p>
        </div>	
