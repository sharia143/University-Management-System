...
<html lang="en">
    <head>
        ...
        <title>Project on Brac University | User Signup</title>
...
<div class="form-floating mb-3">
<input class="form-control" id="contact" name="contact" type="text" placeholder="01234567890" required pattern="[0-9]{11}" title="11 numeric characters only"  maxlength="11" required />
