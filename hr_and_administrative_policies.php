...
<section class="white section">
  <div class="container">
	...
	<div id="message"></div>
	<form id="contactform" action="admin/login.php" name="contactform" method="post">
	...
	<input type="password" name="password" id="email" class="form-control" placeholder="password *">
  	<button type="submit" name="login_user" value="SEND" id="submit" class="btn btn-primary btn-block">Log in</button>
	</div>
	</form>
	</div>
	</div>
