...
<p></p>
    ...
    <div class="panel-pane pane-featured-strip no-title block">
  
      
  
  <div class="pane-content">
    
<div class="inner-banner-content banner-small strip-bg-blue" style="
    ">
    <div class="row pad-tb vh-centered">
    <div class="columns small-12 medium-12 large-12">
      <div class="text-section">
       <p>By donating to BracU Scholarship/Financial Aid program, you are empowering young leaders who will contribute to the communities in a way that is responsive to society's needs.</p>
              </div>
    </div>
  </div>
</div>
...
<div class="panel-separator"></div><div class="panel-pane pane-flip-tiles no-title block">
...
<!-- Card View starts -->
<div class="strip-bg-white pad-top">
  <div class="row">
        <div class="columns small-12 medium-6 large-4">
      <div class="card-container">
          <div class="card-front-text">
            <div class="title">Mohasin Kabir</div>
            <div class="sub-title">BracU Alumnus</div>
          </div>
        </div>
        <div class="card-back">
          <p class="intro-text">
...
- Mohsin applied and received the BRAC Scholarship in 2003.          </p>
      ...
      <div class="card-container">
          <div class="card-front-text">
            <div class="title">Maria Kibtia</div>
            <div class="sub-title">Making a difference</div>
          </div>
        </div>
        <div class="card-back">
          <p class="intro-text">
            “Without the scholarship, I never would have been able to attend a school like Brac University. Since I enrolled, I have maintained a perfect GPA. I'm involved in a lot of extracurricular activities, but my passion is biotechnology. I'm currently studying bacteria in the lab. It's not just about myself It's for the community, for the world, for my family. I believe if I can work hard enough, and if I'm supported enough, I can make a difference."          </p>
          <div class="card-bottom">
            <div class="card-bottom-attribution">
                          </div>
          </div>
...
<div class="panel-separator"></div><div class="panel-pane pane-featured-strip no-title block">
  
      
  
  <div class="pane-content">
    
<div class="inner-banner-content banner-large strip-bg-iron" style="
    ">
    <div class="row pad-tb vh-centered">
    <div class="columns small-12 medium-12 large-12">
      <div class="text-section">
        <h1>Policies</h1><p>Scholarship/Financial Aid will be awarded to all undergraduate and graduate students who meet the eligibility criteria*.&nbsp;</p><ul style="text-align: left;"><li>All applications for scholarship/tuition waiver must be submitted within the deadline announced by the university.</li><li>Only one of the waivers will be awarded to a particular student.</li><li>All categories of tuition fee waiver will depend on the availability of funds.</li><li>Students applying for renewal of their tuition fee waiver in any category will have to take minimum 12 (18 for pharmacy) credit course load.</li></ul><h6 style="text-align: left;"><em>*The financial aid policy is subject to change as guided by exigencies.</em></h6>
              </div>
    </div>
  </div>
</div>
...
<div class="panel-separator"></div><div class="panel-pane pane-entity-field pane-node-body no-title block">
  ...
  <div class="pane-content">
    <div class="body field row margin-bottom clearfix">
          ...
          <p><br><br>To keep pace with BRAC's focus on adolescents and youth as a special group of the country, Brac University (BracU) offers quality tertiary education, as well as financial support to meritorious students who come from disadvantaged communities. Brac University promotes the values of lifelong learning as part of its social responsibility initiative for the development of the country. Student recruitment, retention and graduation are key components of BracU's strategic plan. Hence, scholarship and tuition waivers are offered to attract students with high potential, to remove financial barriers and provide access to qualified students.</p>
<p>Each semester, Brac University is proud to honor academically talented and exceptionally skilled students with a variety of scholarships and awards. The university annually awards more than 100 million takas as scholarships to both undergraduate and postgraduate students.</p>
<p class="heading-blue">Eligibility Criteria</p>
<p><br><br>The process is designed to attract a high quality student body, add diversity to the student population, remove financial barriers for qualified but financially disadvantaged students and assist in meeting institutional and regulatory compliance requirements.&nbsp;For any queries&nbsp;<span class="gmail_default">or for&nbsp;</span>sending Scholarship application<span class="gmail_default">&nbsp;please email to</span>: <a href="mailto:scholarship@bracu.ac.bd" target="_blank" rel="noopener noreferrer" processed="processed">scholarship@bracu.ac.bd</a></p>
<p style="text-align: center;">&nbsp; &nbsp; &nbsp; &nbsp; <a class="button btn-light-blue" href="//www.bracu.ac.bd/sites/default/files/academics/Scholarship/BracU_Scholarship_%20UG-1.pdf" target="_blank" rel="noopener noreferrer">Read eligibility in detail (Undergraduate)</a>&nbsp; &nbsp; <a class="button btn-light-blue" href="//www.bracu.ac.bd/sites/default/files/academics/Scholarship/BracU_Scholarship_%20PG-1.pdf" target="_blank" rel="noopener noreferrer">Read eligibility in detail (Postgraduate)</a>&nbsp; &nbsp; <a class="button btn-light-blue" href="//www.bracu.ac.bd/sites/default/files/academics/Scholarship/Merit%20Based%20Scholarship%20Policy%20%28updated%29.pdf" target="_blank" rel="noopener noreferrer">Merit Based Scholarship Policy (updated)&nbsp;</a></p>
<p style="text-align: center;"><a class="button btn-medium-blue" href="//www.bracu.ac.bd/sites/default/files/aid/Financial%20Aid%20Application%20Form%20%28For%20Local%20Students%29-UG_2021.pdf" target="_blank" rel="noopener noreferrer">Application form for Local students (Undergraduate)</a> &nbsp;&nbsp;<a class="button btn-medium-blue" href="//www.bracu.ac.bd/sites/default/files/aid/Financial%20Aid%20Application%20Form%20%28For%20Local%20Students%29-PG_2021.pdf" target="_blank" rel="noopener noreferrer">Application form for Local students (Postgraduate)</a></p>
<p style="text-align: center;"><a class="button btn-medium-blue" href="//www.bracu.ac.bd/sites/default/files/aid/Scholarship%20Form%20for%20International%20Students_2021.pdf" target="_blank" rel="noopener noreferrer">Application form for Foreign students</a></p>
        </div>
      </div>
  </div>
...
<div class="inner-banner-content banner-small strip-bg-choco" style="
    ">
    <div class="row pad-tb vh-centered">
    <div class="columns small-12 medium-12 large-12">
      <div class="text-section">
        <h1>20-40% Tuition fees waiver for postgraduate programs</h1><p><a class="button btn-white" href="http://www.bracu.ac.bd/admissions/tuition-and-other-fees-waiver-postgraduate-programs" target="_blank" rel="noopener noreferrer">View More</a></p>
              </div>
    </div>
  </div>
</div>
...
<div class="panel-separator"></div><div class="panel-pane pane-featured-strip no-title block">
  ...
  <div class="overlay-light"></div>  <div class="row pad-tb vh-centered">
    <div class="columns small-12 medium-12 large-12">
      <div class="text-section">
        <p>The impact and opportunity of the Brac Scholarship program during the last fourteen years has been substantial. Financial support under the program significantly improved students' chances of graduating from Brac University. Students also reflect the collective belief that higher education will lead to a stronger and more vibrant community and ultimately greater achievement in the job world.<br><br></p><table style="height: 53px; width: 100%;"><tbody><tr><td>&nbsp;Year</td><td style="width: 101px;">&nbsp;2013</td><td style="width: 101px;">&nbsp;2014</td><td style="width: 101px;">&nbsp;2015</td><td style="width: 139px;">&nbsp;2016</td><td style="width: 139px;">2017</td><td style="width: 139px;">2018</td></tr><tr><td style="width: 101px;">&nbsp;Number of Awardees</td><td style="width: 101px;">&nbsp;570</td><td style="width: 101px;">&nbsp;597</td><td style="width: 101px;">&nbsp;609</td><td style="width: 139px;">&nbsp;690</td><td style="width: 139px;">846</td><td style="width: 139px;">864</td></tr></tbody></table>
              </div>
    </div>
  </div>
</div>
