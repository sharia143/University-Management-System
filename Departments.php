...
<p></p>
	...
	<div class="col-md-9 col-sm-9 col-xs-12 content-widget">
		...
		<div class="row l-boxes box-three">
                  ...
                  <article class="m-box s-related">
            <div class="m-box-content">
              
                <div class="box-img-wrapper">
                                    <img src="https://www.bracu.ac.bd/sites/default/files/styles/dept_landing_feature_box_small/public/banner-images/THUMBNAIL.jpg?itok=Mu4YXoAq" alt="relate-cont">
                                  </div>
                <div class="box-content">
                  <h2 class="headline">Department of Architecture</h2>
                  <div class="text">
                    The department undertakes research programs in different areas. It has done so in association with the Research and Education division of BRAC, the British Council, the University of Manchester, Loughborough University, Hoge School Van Amsterdam etc.                  </div>
                </div>
            ...
            <div class="m-box-content">
                ...
                <div class="box-img-wrapper">
                                    <img src="https://www.bracu.ac.bd/sites/default/files/styles/dept_landing_feature_box_small/public/widget_images/static_content/20171130_124902.jpg?itok=kdZ-Ss5a" alt="relate-cont">
                                  </div>
                <div class="box-content">
                  <h2 class="headline">Department of Computer Science and Engineering</h2>
                  <div class="text">
                    The undergraduate and graduate programs offered by this department prepare students to be well-qualified for academia and the industry.                  </div>
                </div>
            ...
            <div class="m-box-content">
                <div class="box-img-wrapper">
                                    <img src="https://www.bracu.ac.bd/sites/default/files/styles/dept_landing_feature_box_small/public/banner-images/ess_eco.jpg?itok=RxEvdam3" alt="relate-cont">
                                  </div>
                <div class="box-content">
                  <h2 class="headline">Department of Economics and Social Sciences</h2>
                  <div class="text">
                    Since its establishment, the department has given special attention to critical pedagogical methods in and outside classroom.                  </div>
                </div>            
            </div>
          </article>
            ...
            <div class="m-box-content">
                ...
                <div class="box-img-wrapper">
                                    <img src="https://www.bracu.ac.bd/sites/default/files/styles/dept_landing_feature_box_small/public/Department%20website%20front%20photo.jpg?itok=0knG06Vf" alt="relate-cont">
                                  </div>
                <div class="box-content">
                  <h2 class="headline">Department of Electrical and Electronic Engineering</h2>
                  <div class="text">
                    Besides the academic programs, the department actively encourages both undergraduate and graduate students to engage themselves in research.                  </div>
                </div>
            ...
            <div class="m-box-content">
                <div class="box-img-wrapper">
                                    <img src="https://www.bracu.ac.bd/sites/default/files/styles/dept_landing_feature_box_small/public/news-image/enh-march-2016-Int-conference-1.jpg?itok=I1MJKbvB" alt="relate-cont">
                                  </div>
                <div class="box-content">
                  <h2 class="headline">Department of English and Humanities</h2>
                  <div class="text">
                    The Department fosters the imaginative, observational, analytical and communicative skills of its students through its three major streams: Literature, Linguistics &amp; ELT and Media.                  </div>
                </div>
            </div>
          </article>
            ...
            <div class="m-box-content">
                <div class="box-img-wrapper">
                                    <img src="https://www.bracu.ac.bd/sites/default/files/styles/dept_landing_feature_box_small/public/Math-Olympiad-2016-MNS-large-1.jpg?itok=IhGE1CM5" alt="relate-cont">
                                  </div>
                <div class="box-content">
                  <h2 class="headline">Department of Mathematics and Natural Sciences</h2>
                  <div class="text">
                    Providing quality education in basic and applied sciences to the students of different disciplines of BRACU including its own                  </div>
                </div>
            </div>
          </article>
            ...
            <div class="m-box-content">
                <div class="box-img-wrapper">
                                    <img src="https://www.bracu.ac.bd/sites/default/files/styles/dept_landing_feature_box_small/public/image_lab_2.png?itok=HFmcweG3" alt="relate-cont">
                                  </div>
                <div class="box-content">
                  <h2 class="headline">Department of Pharmacy</h2>
                  <div class="text">
                    Through an integrated course curriculum students will gain an understanding of the interrelationships between physical pharmacy principles, biopharmaceutics and pharmacokinetics, dosage form design, product formulation, small- and large-scale product manufacture, and the clinical application of pharmaceuticals in patient care.                  </div>
                </div>
            </div>
          </article>
