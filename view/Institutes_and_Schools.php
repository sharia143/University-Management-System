...
<li class="dropdown ttmenu-half"><a class="active" href="#" data-toggle="dropdown" class="dropdown-toggle">Academic<b class="fa fa-angle-down"></b></a>
	<ul class="dropdown-menu">
	<li>
	<div class="ttmenu-content">
	<div class="row">
...
<p></p>
	...
	<div class="col-md-9 col-sm-9 col-xs-12 content-widget">
		...
		<div class="field-item even">
          <h3 style="text-align: left;"><strong>Brac Business School</strong></h3>
<p style="text-align: left;">The Brac Business School (<strong>BBS</strong>) offers an undergraduate program (<em><strong>BBA, Bachelor of Business Administration</strong></em>).&nbsp;</p>
<p style="text-align: left;">The areas of specialization of the school are:</p>
<ul style="text-align: left;"><li>Accounting</li>
<li>Finance</li>
...
</ul><h3><strong>School of&nbsp;Data and Sciences</strong></h3>
<p>The School of Data &amp; Sciences is composed of the Deparment of Computer Science and Engineering (CSE) and the Mathematics &amp; Natural Sciences Department (MNS).&nbsp; It is the largest school in the university.&nbsp; The school's focus is core computer science and engineering and fundamental sciences. Using the combined expertise of both the CSE and MNS departments it aims to be a leader in data science and related areas.&nbsp;&nbsp;</p>
<h3><strong>School of Engineering</strong></h3>
<div id="stcpDiv" style="position: absolute; top: -1999px; left: -1988px; text-align: left;">the school offers an undergraduate program (BBA, Bachelor of Business Administration) and two graduate programs (MBA, Masters of Business Administration and EMBA, Executive Masters in Business Administration). The areas of specialization of the school are Accounting, Finance, Banking and Insurance, Human Resource Management, Marketing, Computer Information Management, E-Business, Entrepreneurship, and Operations Management.</div>
<p style="text-align: left;">The School of Engineering is currently composed of the Department of Electrical &amp; Electronic Engineering (EEE). It intends to be the globally-recognized eminent engineering and computing school through excellence in teaching, research, innovation and technological entrepreneurship. It is our mission to produce technically competent, socially responsible, best quality engineering graduates with effective communication skills, highest ethical standards and human values...<a href="//www.bracu.ac.bd/academics/institutes-and-schools/school-engineering-and-computer-science" target="_blank" rel="noopener noreferrer">Read More</a></p>
<h3 style="text-align: left;"><a href="//www.bracu.ac.bd/academics/institutes-and-schools/school-law">School of Law</a></h3>
<p>The <a href="//www.bracu.ac.bd/academics/institutes-and-schools/school-law">School of Law</a> at Brac University is a gateway through which students are prepared for careers in law, in administrative services, the judiciary and in the development sector. The four-year undergraduate programme at the School of Law culminates into a<em><strong> Bachelor of Laws (LL.B.)</strong></em> degree for successful students. Although the primary emphasis of the programme is on law and the legal profession, given that law is intertwined with economics, development, business and sociology, it also prepares students who are inclined to seek professions in other disciplines.</p>
<h3><a href="//www.bracu.ac.bd/academics/institutes-and-schools/school-humanities-and-social-sciences" target="_blank" rel="noopener noreferrer">School of Humanities and Social Sciences</a></h3>
<p><a href="//www.bracu.ac.bd/academics/institutes-and-schools/school-humanities-and-social-sciences" target="_blank" rel="noopener noreferrer">School of Humanities and Social Sciences (SHSS)</a> Founded in 2019, our School supervises our university's teaching and research activities in the liberal arts. The SHSS&nbsp;Departments of Economics and Social Sciences and of English and Humanities offer:</p>
<ul><li>a Master of Arts in English,</li>
<li>a Master of Science in Applied Economics,</li>
<li>a Bachelor of Arts in English,</li>
<li>two Bachelors of Social Science in Economics and Anthropology,</li>
<li>minors in Anthropology, Economics, History, and Sociology.</li>
</ul><h3 style="text-align: left;"><strong>James P Grant School of Public Health</strong></h3>
<p style="text-align: left;">The&nbsp;James P Grant School of Public Health (JPGSPH)&nbsp;at Brac University was established in 2004 as an international educational and research institution focusing on the integral areas of teaching, research, and services. The goal of the School is not only to impart knowledge but also to act as a centre of excellence in knowledge creation through research and training that connect with practice.<br><br>The School’s guiding vision - “<em>knowledge and know-how for health equity</em>” - draws on the inspirational leadership of James P. Grant, former executive director of UNICEF, after whom the School is named. The three primary areas of activity in the School are related to education, research and advocacy.</p>
<p style="text-align: left;">Aside from the flagship educational programmes, i.e.&nbsp;<strong>Master of Public Health (MPH)</strong>, JPGSPH also provides public health short courses for health professionals through the Continuing Education Programme (CEP). Additionally, JPGSPH possesses a burgeoning research portfolio conducting innovative and pioneering studies on public health issues funded by multiple international donors. JPGSPH also offers services in the form of training, advocacy workshops, and seminars with a special focus on the rights of the marginalized and vulnerable population of Bangladesh.</p>
<h3><strong>School of Architecture and Design(SoAD)</strong></h3>
<p>The School of Architecture and Design(SoAD)&nbsp;is Brac University’s new venture. This follows from the tradition set by the Department of Architecture, which has established a name for itself in high quality design education. The School will be comprehensive in its scope to include design disciplines that has relevance to the local context as well as international trends.</p>
<h3><strong>Brac Institute of Languages</strong></h3>
<p>Brac Institute of Languages (BIL) of BRAC University is working with the goal to assist students in developing the language skills they need to become successful in graduate schools and in their professional lives. BIL focuses on implementing student-centered and creative language teaching techniques by developing modules based on students’ proficiency level. This not only helps avoid having mixed ability classes, but also ensures small classes with excellent interaction between teachers and learners.</p>
<p>BIL offers well-designed, comprehensive courses ranging from the pre-intermediate to the upper-intermediate level in order to facilitate the <strong>English</strong> language requirements of the university students. Besides English, BIL currently offers the modern languages <strong>Bangla</strong>, <strong>German</strong>, <strong>Chinese</strong>, <strong>French</strong>, <strong>Arabic</strong> and <strong>Spanish</strong> to both its students and other professionals.</p>
<p>Additionally, BIL offers Pre-University, which is a unique course designed for those students who proved themselves competent in their respective disciplines during the admission test except in English. Besides, <strong>MA in TESOL</strong>, the flagship programme of BIL, is creating efficient English language teachers and leaders from around the country with its well organized curriculum, and innovative and practice-oriented teaching approach.</p>
<h3><strong>Brac Institute of Educational Development</strong></h3>
<p>Since its inception it has been contributing to the overall improvement of the national education system in Bangladesh. Brac Institute of Educational Development (<strong>BRAC IED</strong>) runs two academic programmes, the <em><strong>Masters of Education (MEd)</strong></em>/ <em><strong>Post-Graduate Diploma (PGD) in Educational Leadership, Planning, and Management</strong></em> as well as the <em><strong>Masters in Science (MSc)/PGD in Early Childhood Development</strong></em>. BRAC IED also runs short courses for government officials who share our vision of bringing positive change to classroom teaching, learning, and management.</p>
<h3 style="text-align: left;"><strong><br>
  Brac Institute of Governance and Development</strong></h3>
<p style="text-align: left;">Brac Institute of Governance and Development&nbsp;(<strong>BIGD</strong>) is a resource center that promotes research and develops knowledge on practical solutions to issues of poverty, inequity and social injustice. At the core of BIGD’s work are several academic courses, which include both classroom teaching and fieldwork experience:</p>
<ul><li>Master of Development Studies (MDS)</li>
<li>Masters in Procurement and Supply Management (MPSM)</li>
<li>Master of Arts in Governance and Development (MAGD)</li>
<li>Post Graduate Diploma in Knitwear Industry Management (PGD-KIM)</li>
<li>The Chartered Institute of Procurement &amp; Supply (CIPS)</li>
<li>Academy of Work (AoW)</li>
